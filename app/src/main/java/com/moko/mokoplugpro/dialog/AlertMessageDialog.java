...
import com.moko.mokoplugpro.databinding.DialogAlertProBinding;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class AlertMessageDialog extends MokoBaseDialog<DialogAlertProBinding> {
    ...
    @Override
    protected DialogAlertProBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogAlertProBinding.inflate(inflater, container, false);
    }
